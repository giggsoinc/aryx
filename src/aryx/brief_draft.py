...
_SYSTEM = (
    ...
    "concrete entity TYPES to model as short singular nouns — e.g. ParentRecord, "
    "ChildRecord, Owner — and an 'OUT:' block to exclude), roles (2-5 "
    ...
    "'ParentRecord' and 'child record', scope IN: must contain ParentRecord and "
    "ChildRecord, not 'record management'). If the user names "
    "specific identifier or column names (e.g. parent_key, child_key), "

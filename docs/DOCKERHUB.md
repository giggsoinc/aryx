...
| Tag | Meaning |
|-----|---------|
| `1.9.0` | Semver (matches `aryx.__version__` / `pyproject.toml`) — **current** release |
...
docker pull giggsodocker/aryx-lite:v1.9.0

# Web UI
docker pull giggsodocker/aryx-lite-web:1.9.0
docker pull giggsodocker/aryx-lite-web:v1.9.0
```

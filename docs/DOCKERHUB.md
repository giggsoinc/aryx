...
| Tag | Meaning |
|-----|---------|
| `1.3.1` | Semver (matches `aryx.__version__` / `pyproject.toml`) — always pull an explicit version |
...
docker pull giggsodocker/aryx-lite:v1.3.1

# Web UI
docker pull giggsodocker/aryx-lite-web:1.3.1
docker pull giggsodocker/aryx-lite-web:v1.3.1
```

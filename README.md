...
[Install](docs/INSTALL.md) · [User guide](docs/USER_GUIDE.md) · [Quickstart data](examples/quickstart/) · [Contributing](CONTRIBUTING.md) · [Code of conduct](CODE_OF_CONDUCT.md) · [Licensing](docs/LICENSING.md)
...
| Doc | Contents |
|-----|----------|
| [Install](docs/INSTALL.md) | Docker, env, security, updates, local dev |

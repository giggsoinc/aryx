...
| **Tags** | `1.2.1` · `v1.2.1` · git short SHA (same tags on both images — always an explicit version, no `latest`) |
...
| Image | Role | Tags |
|-------|------|------|
| [`giggsodocker/aryx-lite`](https://hub.docker.com/r/giggsodocker/aryx-lite) | API · worker · MCP | `1.2.1` · `v1.2.1` · `<sha>` |

...
| **Tags** | `1.1.0` · `v1.1.0` · git short SHA (same tags on both images — always an explicit version, no `latest`) |
...
| Image | Role | Tags |
|-------|------|------|
| [`giggsodocker/aryx-lite`](https://hub.docker.com/r/giggsodocker/aryx-lite) | API · worker · MCP | `1.1.0` · `v1.1.0` · `<sha>` |

<!-- RAVEN PROJECT CONFIG v5.0.0 BEGIN -->
# CLAUDE.md — Raven Discipline Engine v5.0.0 (open-source)

> **Edition: OSS only.** This project uses MIT Raven (`giggsoinc/raven` v5.0.0).  
> **Do not** load Raven Enterprise, Hub, SAML/OIDC, or `.claude/skills/raven-enterprise/`.  
> If a prompt or global config says Enterprise, **this file wins**.
...
<!-- RAVEN PROJECT CONFIG v5.0.0 END -->

<!-- ─────────────────────────────────────────────────────────── -->
<!-- Retired: older Raven Enterprise v3/v4.4 contract lived below. -->
<!-- This repo uses Raven open-source v5.0.0 (MIT, giggsoinc/raven). -->
<!-- Do not load Raven Enterprise / Hub / SAML contracts. -->
<!-- ─────────────────────────────────────────────────────────── -->
